...
library('GO.db')
library(ChIPseeker)
library(org.Mm.eg.db)  # 小鼠基因 ID 转换、GO 注释等
library(TxDb.Mmusculus.UCSC.mm10.knownGene)  # 小鼠基因组注释（mm10 版本）
library(ggupset)
...
dat_peakAnno <- annotatePeak(dat, tssRegion = c(-3000, 3000), TxDb = txdb, annoDb="org.Mm.eg.db")
